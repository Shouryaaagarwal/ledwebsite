...
//   // useSearchParams now works safely inside Suspense boundary
            ...
            <p className="text-gray-600">
              ...
              <button 
                ...
                onClick={() => {
                  ...
                  const hasPendingVerification = localStorage.getItem('pending-verification') === 'true';
                  if (hasPendingVerification) {
                    alert('Please verify your email first before signing in. Check your email for the verification link.');
                    return;
                  }
                  router.push('/auth/signin');
                }}
